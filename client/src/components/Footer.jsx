      ...
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          ...
          <div className="flex items-center gap-3 mt-4">
            <svg
              className="cursor-pointer w-6 h-6 hover:text-pink-600"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <svg
              className="cursor-pointer w-6 h-6 hover:text-blue-600"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <svg
              className="cursor-pointer w-6 h-6 hover:text-blue-400"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <svg
              className="cursor-pointer w-6 h-6 hover:text-blue-500"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
