...
const MoblieApp = () => {
  return (
    <div className="flex justify-center flex-col items-center py-20 max-sm:px-5">
      ...
      <div className="flex flex-col md:flex-row items-center justify-around text-sm border border-gray-300 rounded-md m-2 mt-5 max-w-5xl w-full bg-gradient-to-r from-[#F5F2FF] to-[#FBF6FF]">
